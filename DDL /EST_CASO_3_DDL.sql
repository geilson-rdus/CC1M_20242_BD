...
ALTER TABLE REGISTROS_MANUTENCAO ADD COLUMN NOME_RM TEXT NOT NULL;
ALTER TABLE REGISTROS_MANUTENCAO MODIFY COLUMN NOME_RM VARCHAR(100);
ALTER TABLE REGISTROS_MANUTENCAO CHANGE COLUMN NOME_RM NOMES_RM VARCHAR(100);
ALTER TABLE REGISTROS_MANUTENCAO DROP COLUMN NOMES_RM;
